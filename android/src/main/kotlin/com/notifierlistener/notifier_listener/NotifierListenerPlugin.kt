...
/**
 * NotifierListenerPlugin
 */
class NotifierListenerPlugin private constructor(private val context: Context) : StreamHandler {
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      ...
      val plugin = NotifierListenerPlugin(context)
